...
-- TABLA CLIENTE
INSERT INTO cliente (id, email, nombre, apellidos, telefono, postal, rol) VALUES
('a', 'admin@gmail.com', 'Nombre', 'Apellidos', '123-456-7890', '12345', 0),
('b', 'john.doe1@example.com', 'John', 'Doe', '123-456-7890', '12345', 0),
('c', 'jane.smith2@example.com', 'Jane', 'Smith', '987-654-3210', '54321', 0),
('d', 'alex.jones3@example.com', 'Alex', 'Jones', '555-123-4567', '67890', 0),
('e', 'lisa.brown4@example.com', 'Lisa', 'Brown', '444-987-6543', '11223', 0),
('f', 'mike.davis5@example.com', 'Mike', 'Davis', '222-333-4444', '33445', 0),
('g', 'susan.clark6@example.com', 'Susan', 'Clark', '777-888-9999', '99887', 0),
('h', 'robert.white7@example.com', 'Robert', 'White', '666-555-4444', '55443', 0),
('i', 'nancy.green8@example.com', 'Nancy', 'Green', '111-222-3333', '66778', 0),
('j', 'david.hall9@example.com', 'David', 'Hall', '999-888-7777', '77889', 0),
('k', 'emma.taylor10@example.com', 'Emma', 'Taylor', '333-444-5555', '88900', 0);
...
('Muy buen producto, lo recomiendo!', 3, 'k'),
('La calidad es excelente, vale cada centavo.', 45, 'b'),
('El artículo llegó antes de tiempo y en perfecto estado.', 12, 'c'),
('El diseño es muy moderno y funcional.', 78, 'd'),
('El producto no cumplió con mis expectativas.', 9, 'e'),
('Es justo lo que estaba buscando, gracias!', 34, 'f'),
('El precio es competitivo y la calidad es buena.', 22, 'g'),
('Llegó con algunos defectos, pero el servicio fue rápido.', 56, 'h'),
('La descripción del producto es precisa, estoy satisfecho.', 88, 'i'),
('Gran compra, definitivamente volveré a comprar aquí.', 50, 'j'),
('El envío fue rápido, pero el embalaje podría mejorar.', 15, 'k'),
('Excelente atención al cliente, resolvieron mis dudas rápido.', 72, 'b'),
('El material es de buena calidad, lo recomendaría.', 44, 'c'),
('Me sorprendió lo bien que funciona, muy contento.', 11, 'd'),
('No esperaba mucho por el precio, pero fue una grata sorpresa.', 67, 'e'),
('Muy bonito, pero no es tan resistente como esperaba.', 33, 'f'),
('Es un buen producto, pero el color no es como en las fotos.', 5, 'g'),
('Cumple con lo prometido, nada más que decir.', 40, 'h'),
('La relación calidad-precio es fantástica.', 31, 'i'),
('Fue un regalo, y a la persona le encantó.', 99, 'j'),
('Muy buen producto, lo recomiendo mucho.', 2, 'c'),
('El artículo llegó rápidamente y en excelente estado.', 55, 'd'),
('No me ha convencido, esperaba más por el precio.', 29, 'e'),
('Excelente calidad, me sorprendió gratamente.', 68, 'f'),
('El producto es exactamente lo que buscaba, muy satisfecho.', 27, 'g'),
('El color es un poco diferente, pero sigue siendo bonito.', 10, 'h'),
('Perfecto para mi uso diario, lo recomendaría.', 42, 'i'),
('Llegó en buen estado, pero el embalaje podría mejorar.', 17, 'j'),
('No es tan resistente como esperaba, pero aún así está bien.', 21, 'k'),
('La calidad es buena, pero el tamaño no era el que esperaba.', 39, 'b'),
('El producto cumple su función, pero el precio es un poco alto.', 61, 'c'),
('Estaba dudoso, pero me ha encantado, gran compra.', 19, 'd'),
('El servicio de atención al cliente fue muy bueno y rápido.', 33, 'e'),
('Me gustó mucho, pero el color no es tan vibrante como en la foto.', 73, 'f'),
('Excelente relación calidad-precio, muy recomendable.', 24, 'g'),
('El envío fue muy rápido, y el artículo es de buena calidad.', 58, 'h'),
('El artículo tiene una gran calidad, pero el tamaño no es adecuado para mí.', 49, 'i'),
('El producto está bien, aunque esperaba una mejor durabilidad.', 13, 'j'),
('Lo recomiendo al 100%, buen artículo y buen precio.', 32, 'k'),
('El diseño es excelente, me encanta cómo queda en mi casa.', 61, 'b'),
('Muy bonito, aunque llegó un poco tarde.', 76, 'c'),
('La calidad es espectacular, pero no me gustó el tamaño.', 20, 'd'),
('La descripción es precisa, pero la calidad no es tan buena como esperaba.', 4, 'e'),
('Excelente compra, se ajusta perfectamente a mis necesidades.', 38, 'f'),
('Cumple con todo lo prometido, muy satisfecho con la compra.', 65, 'g'),
('El artículo llegó en perfectas condiciones y dentro del plazo de entrega.', 8, 'h'),
('Me ha encantado, el precio es razonable y la calidad es buena.', 57, 'i'),
('Excelente compra, volveré a comprar sin duda.', 46, 'j'),
('El producto es bueno, pero la entrega fue más lenta de lo esperado.', 1, 'k'),
('El artículo es tal como se describe, estoy muy contento con la compra.', 26, 'b'),
('No me ha convencido, el artículo no es tan bueno como pensaba.', 64, 'c'),
('Un buen producto, pero el tamaño es un poco pequeño para lo que necesitaba.', 71, 'd'),
('Muy buen producto, fácil de usar y de excelente calidad.', 12, 'b'),
('El artículo llegó bien, aunque un poco tarde.', 46, 'c'),
('La calidad es increíble, no me arrepiento de la compra.', 57, 'd'),
('El tamaño no es el que esperaba, pero sigue siendo útil.', 81, 'e'),
('Perfecto para lo que necesitaba, gran compra.', 29, 'f'),
('Muy bonito, pero un poco más caro de lo que esperaba.', 17, 'g'),
('Lo recomiendo totalmente, es justo lo que buscaba.', 54, 'h'),
('El envío fue un poco lento, pero el artículo está bien.', 82, 'i'),
('Buen producto, aunque el color no es exactamente como en las fotos.', 23, 'j'),
('Es un buen producto por el precio, aunque no es perfecto.', 35, 'k'),
('Muy buen diseño, aunque el material no es tan resistente como esperaba.', 76, 'b'),
('El producto llegó en perfectas condiciones, pero la caja estaba dañada.', 40, 'c'),
('La calidad es excelente, aunque un poco costoso.', 52, 'd'),
('El artículo no cumplió con mis expectativas, lo devolveré.', 93, 'e'),
('Me gusta mucho, pero me gustaría que tuviera más opciones de color.', 66, 'f'),
('Es exactamente lo que esperaba, excelente compra.', 51, 'g'),
('Me sorprendió la calidad por el precio, muy buen producto.', 60, 'h'),
('El artículo no es tan grande como parece en las fotos, pero aún está bien.', 79, 'i'),
('Muy satisfecho con la compra, lo recomendaría a otros.', 49, 'j'),
('Buena relación calidad-precio, pero la entrega fue lenta.', 25, 'k'),
('El artículo es de buena calidad, pero no es tan cómodo como pensaba.', 71, 'b'),
('El servicio al cliente fue rápido y resolvió mis dudas, muy satisfecho.', 39, 'c'),
('Cumple su función, pero esperaba mejor durabilidad.', 88, 'd'),
('Buen producto, aunque el diseño podría ser mejor.', 33, 'e'),
('Me ha gustado, pero llegó un poco sucio.', 45, 'f'),
('El producto es bueno, aunque el tamaño no es el ideal para mí.', 58, 'g'),
('No me convenció, esperaba más por el precio.', 37, 'h'),
('Me encantó el producto, cumple con todo lo que promete.', 66, 'i'),
('Excelente artículo, aunque el embalaje no fue el mejor.', 72, 'j'),
('La calidad es buena, pero llegó con algunos rayones.', 20, 'k'),
('Me encanta el diseño, pero no es tan fácil de usar como esperaba.', 48, 'b'),
('Muy buen producto, lo seguiré comprando.', 10, 'c'),
('El producto es bueno, aunque el color no me gustó mucho.', 59, 'd');

-- Insertando 20 pedidos
INSERT INTO pedido (fecha, importe, modo_entrega, gastos_envio, estado, cliente_id, tienda_id)
VALUES 
('2024-12-01', 372.58, 'envio', 15.00, 'procesando', 'b', 1),
('2024-12-02', 258.90, 'envio', 12.00, 'enviado', 'd', 1),
('2024-12-03', 489.45, 'envio', 18.50, 'entregado', 'g', 1),
('2024-12-04', 124.75, 'envio', 10.00, 'procesando', 'f', 1),
('2024-12-05', 736.18, 'envio', 20.00, 'entregado', 'e', 1),
('2024-12-06', 289.35, 'envio', 15.50, 'enviado', 'c', 1),
('2024-12-07', 115.60, 'envio', 8.50, 'procesando', 'f', 1),
('2024-12-08', 561.12, 'envio', 17.00, 'entregado', 'j', 1),
('2024-12-09', 451.20, 'envio', 16.00, 'enviado', 'b', 1),
('2024-12-10', 320.48, 'envio', 14.50, 'procesando', 'h', 1),
('2024-12-11', 513.75, 'envio', 19.00, 'entregado', 'd', 1),
('2024-12-12', 467.40, 'envio', 15.80, 'enviado', 'g', 1),
('2024-12-13', 235.67, 'envio', 9.50, 'procesando', 'f', 1),
('2024-12-14', 527.60, 'envio', 18.00, 'entregado', 'e', 1),
('2024-12-15', 613.95, 'envio', 20.00, 'enviado', 'f', 1),
('2024-12-16', 372.99, 'envio', 12.75, 'procesando', 'c', 1),
('2024-12-17', 341.23, 'envio', 13.50, 'enviado', 'b', 1),
('2024-12-18', 468.55, 'envio', 16.20, 'entregado', 'j', 1),
('2024-12-19', 526.80, 'envio', 14.00, 'procesando', 'h', 1),
('2024-12-20', 602.34, 'envio', 18.30, 'enviado', 'd', 1);
